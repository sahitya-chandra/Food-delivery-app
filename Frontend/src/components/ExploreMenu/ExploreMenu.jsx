...
export default function ExploreMenu({ category, setcategory }) {
    ...
    <div className=" flex flex-col gap-[20px]">
        ...
        <div className="flex justify-between items-center gap-[60px] text-center my-5 mx-0 overflow-x-scroll">
            {menu_list.map((item, index) => {
                return (
                    <div onClick={() => setcategory(prev=>prev===item.menu_name?"All":item.menu_name)}  key={index} className="h-40">
